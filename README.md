...
| [24 貨架取放 X/Z](docs/06-amr/12-steer-reach-xz.md) | 舵輪底盤 + 環氧地板 + 貨架取放 | 搬運 2.07 m、漂移 1.0 cm、平穩落地 |
| [25 全軸取放 X/Y/Z](docs/06-amr/13-reach-xyz.md) | 加上 y 向 reach 側移對位 | 搬運 2.05 m、漂移 3.3 cm、側移 0.49 m |
...
壓到 15%。三個修好之後，貨全程漂移從 110 cm 降到 1.0 cm。**判定實驗成功要看整段軌跡，
不是最後一幀。**
