...
用 MuJoCo 物理引擎寫的 28 篇繁體中文教學、41 支 Python 腳本，以及一整條 AMR 叉車搬運實驗線 —
...
| SAC（SB3） | 未收斂 | 60k | 30 分鐘 | CPU | [12](docs/02-programming/07-sac.md) |
| SAC（zoo 超參） | -0.21 | 60k | 4 分鐘 | RTX Pro 6000（8 環境） | [12](docs/02-programming/07-sac.md) |
| SAC（同上，2026-09-11 重跑） | -0.20 | 60k | 86 秒 | RTX Pro 6000（4 環境） | [12](docs/02-programming/07-sac.md) |

![三種演算法的學習曲線](runs/rl_curves.png)

＊訓練時間是在空閒機器上量的。同樣的 PPO 150k 步，在 load average 超過 20 的機器上要
30 分鐘 —— 牆鐘時間要連機器狀態一起看。
