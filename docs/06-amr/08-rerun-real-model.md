...
```
木頭: 抬起 z=0.369 m, 相對滑動 = 1.3 cm, 留在牙叉上 ✓
塑膠: 抬起 z=0.369 m, 相對滑動 = 1.3 cm, 留在牙叉上 ✓
```
...
3. **要拉開差距需要「摩擦剛好不夠」的中間地帶**（μ·g 介於兩者之間的加速度）——在這台重型車的速度伺服上做不出來。16 章的輕量車 + 專用側移關節反而才是材質對照的正確平台。
...
| --- | --- | --- |
| 材質滑動對照 | 木 0.4 / 塑膠 11.9 cm | 皆 1.3 cm（平台限制） |
